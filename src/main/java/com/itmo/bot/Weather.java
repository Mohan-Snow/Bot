...
import com.itmo.bot.prop.BotProfile;
...
//    }
    ...
    private static URL getUrlForLocation(Message message, String weatherAppid) throws MalformedURLException {
    ...
    public static String getWeather(Message message, String weatherAppid) throws IOException {

        URL url = getUrlForLocation(message, weatherAppid);
